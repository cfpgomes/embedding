...
WS_filename = 'results/WV_N64_B0.5_diversified/IPL_linearized_WV_N64q1.00B32.json'
...
set1_foldername = 'results/scenarioA3_N64_Pformulated_Cformulated1.000_Allocated_layout_diversified_annealer_try5'

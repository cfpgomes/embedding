...
for q in q_values:
    ...
    shutil.copy2('src/ampl/IPL_linearized_WV_template.ampl',
                 f'src/ampl/{folder_name}/IPL_linearized_WV_N{N}q{q:.2f}B{B}.ampl')

    with open(f'src/ampl/{folder_name}/IPL_linearized_WV_N{N}q{q:.2f}B{B}.ampl', 'a') as f:
        solution_file_name = f'results/{folder_name}/IPL_linearized_WV_N{N}q{q:.2f}B{B}_solution.json'

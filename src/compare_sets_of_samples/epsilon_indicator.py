...
B1 = int(N1*0.8)
print(f'B1:{B1}')
classical_solutions1_foldername = 'results/scenarioA2_N32_B0.8_classical'
classical_solutions1 = []

B2 = int(N2*0.9)
print(f'B2:{B2}')
classical_solutions2_foldername = 'results/scenarioA2_N32_B0.9_classical'
...
set1_foldername = 'results/scenarioA2_N32_Pformulated_Cformulated_B0.8_annealer'
set2_foldername = 'results/scenarioA2_N32_Pformulated_Cformulated_B0.9_annealer'

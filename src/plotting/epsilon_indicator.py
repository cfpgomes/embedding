...
B1 = int(N1*0.5)
print(f'B1:{B1}')
classical_solutions1_foldername = 'results/N64_B0.5_diversified_classical'
...
set1_foldername = 'results/scenarioA3_N64_Pformulated_Cformulated1.000_Allocated_layout_diversified_annealer_try1'
set2_foldername = 'results/scenarioA3_N64_Pformulated_Cformulated1.000_Allocated_layout_correlated_annealer_try2'

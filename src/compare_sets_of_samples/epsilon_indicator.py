...
B2 = int(N2*0.9)
print(f'B2:{B2}')
classical_solutions2_foldername = 'results/scenarioA2_N64_B0.9_classical'
...
set1_foldername = 'results/scenarioA2_N64_Pformulated_Cformulated_B0.8_annealer'
set2_foldername = 'results/scenarioA2_N64_Pformulated_Cformulated_B0.9_annealer'

...
B1 = int(N1*0.5)
classical_solutions1_foldername = 'results/scenario1_N32_classical'
...
set1_foldername = 'results/scenario1_N32_annealer'
set2_foldername = 'results/scenario1_N64_annealer'
